...
[![CRAN preflight](https://github.com/alrobles/oneearthr/actions/workflows/cran-preflight.yml/badge.svg)](https://github.com/alrobles/oneearthr/actions/workflows/cran-preflight.yml)
<!-- badges: end -->

Access the **One Earth Bioregions Framework** spatial layers from R: biogeographical
realms, subrealms, bioregions, and ecoregions (RESOLVE Ecoregions 2017).
All layers ship with the package and work offline.
...
- Dinerstein, E., et al. (2017). An Ecoregion-Based Approach to Protecting
  Half the Terrestrial Realm. *BioScience* 67(6).
  [doi:10.1093/biosci/bix014](https://doi.org/10.1093/biosci/bix014) — CC-BY 4.0.
